...
export const metadata: Metadata = {
    title: 'Disclaimer - Bali Journal',
    description: 'Disclaimer for Bali Journal.',
    alternates: {
        ...
        <div className="container mx-auto px-4 py-12 max-w-4xl">
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
                <section>
                    ...
                    <p>
                        Bali Journal uses AI technology to assist with drafting articles, translating and summarizing source
                ...
                <section>
                    ...
                    <p>
                        ...
                        information may change or be updated as a story unfolds. Bali Journal makes no warranty as to the
                ...
                <section>
                    ...
                    <p>
                        Content published on Bali Journal, including coverage of regulations, investment opportunities, or
                ...
                <section>
                    ...
                    <p>
                        ...
                        attribution. Bali Journal does not control and is not responsible for the content, accuracy, or
                ...
                <section>
                    ...
                    <p>
                        ...
                        at{' '}
                        <a href="mailto:info@balijournal.com" className="text-primary hover:underline">
                ...
                <section>
                    ...
                    <p>Bali Journal is published by {COMPANY_NAME}.</p>
                </section>
            </div>
        </div>
    )
