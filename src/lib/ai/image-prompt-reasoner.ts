...
- NEVER default to a lit candle, oil lamp, incense stick, or offering tray (canang sari) as a generic stand-in for "Balinese spirituality/tradition/culture" - this is JUST AS overused a cliche as the newspaper one above, and pushes every abstract/cultural-identity/opinion story toward the same dim room with a glowing flame in it (confirmed as a real recurring pattern across this outlet's published images 2026-09). Only use ceremonial/offering imagery when the story is LITERALLY about a specific ritual, temple ceremony, or religious practice - never as a generic "this is about Bali/culture/tradition" placeholder. When you're tempted to reach for a candle/incense/offering because the story feels abstract, pick a DIFFERENT concrete anchor instead: a specific landscape or landmark, an everyday object tied to the story's actual subject, people in an ordinary daytime setting doing something related to the topic, architecture, a market or street scene, technology, nature/wildlife, or an abstract composition that doesn't rely on a lit flame at all.
