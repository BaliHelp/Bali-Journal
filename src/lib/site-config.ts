...
// string, not new Date(), so it actually reflects the revision date
// instead of always showing today whenever the page happens to be loaded.
// Bump this string when one of those pages is next substantively revised.
export const LEGAL_PAGES_LAST_UPDATED = 'September 1, 2026'
